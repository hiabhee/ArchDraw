...
## Text Elements
Always emit EXACTLY ONE title:
%% archdraw-text: {"id":"title","text":"<descriptive title>","size":"heading","anchor":"top"}

Text directives are invisible to Mermaid renderers.
...
Title: specific descriptive title from the prompt.
Notes: 1-3 architectural notes for non-obvious decisions.`;
}
