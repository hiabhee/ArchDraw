...
describe('Mermaid Editor Real-time Updates', () => {
  ...
  it('should correctly classify shapes and colors based on node name and parent group, and respect explicit shape brackets', () => {
    const code = `graph LR
  ...
  custom_circle(("Explicit Circle Shape"))`;
    ...
    const dbNode = res.nodes.find(n => n.id === 'postgres_db');
