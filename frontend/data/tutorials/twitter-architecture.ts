    ...
    level({
      ...
      steps: [
        ...
        step({
          ...
          parent: 'API Gateway',
          phases: {
            context: { heading: 'Step 3: Load Balancer', body: 'Twitter routes hundreds of thousands of requests per second through load balancers that isolate fan-out spikes from read traffic.' },
            intro: { heading: 'About Load Balancers', body: 'Load balancers distribute API traffic across stateless microservice pools.' },
            teaching: { heading: 'Deep dive: Load Balancer', body: 'When a celebrity tweets, write amplification can overwhelm timeline builders. Load balancers steer read-heavy timeline fetches to dedicated clusters so tweet ingestion stays healthy.' },
        ...
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Tweet Service', and add the Tweet Service." },
            connecting: { heading: 'Connect it up', body: 'Connect Load Balancer \u2192 Tweet Service.' },
            celebration: { heading: 'Great job!', body: 'Tweet Service added.' },
          },
          hints: ['Search for "Tweet Service"', 'Connect API Gateway to it'],
        }),
        step({
      ...
      steps: [
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Timeline Service', and add the Timeline Service." },
          ...
          hints: ['Search for "Timeline Service"', 'Connect API Gateway to it'],
        }),
        step({
          ...
          parent: 'API Gateway',
          phases: {
            context: { heading: 'Level 2: Search Service', body: 'Twitter search indexes tweets, hashtags, and trends in near real-time for the Explore tab.' },
            intro: { heading: 'About Search Services', body: 'Search services power full-text queries and trending topic detection.' },
            teaching: { heading: 'Deep dive: Search Service', body: 'Trending topics require counting hashtag velocity in sliding windows. The search tier ingests the tweet firehose and serves ranked results without scanning raw tweet storage.' },
