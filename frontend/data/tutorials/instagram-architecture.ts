      ...
      steps: [
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K and search for 'Mobile Client' to add the client." },
          ...
          hints: ['Search for "Mobile Client"', 'Add Mobile Client'],
        }),
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K and search for 'Web Client' to add it." },
          ...
          hints: ['Search for "Web Client"', 'Add Web Client'],
        }),
        step({
          component: 'CDN',
          nodeType: 'cdn',
