    ...
    level({
      ...
      steps: [
        ...
        step({
          ...
          parent: 'API Gateway',
          phases: {
            context: { heading: 'Step 5: Load Balancer', body: 'Stripe spreads payment API traffic across isolated clusters so a surge in one region does not affect global authorization rates.' },
            intro: { heading: 'About Load Balancers', body: 'Load balancers distribute requests across horizontally scaled service instances.' },
            teaching: { heading: 'Deep dive: Load Balancer', body: 'Cyber Monday checkout spikes route through auto-scaled payment pods. Health checks drain bad nodes before they cause cascading declines.' },
        ...
        step({
          ...
          phases: {
            ...
            connecting: { heading: 'Connect it up', body: 'Connect Load Balancer \u2192 Ledger.' },
            celebration: { heading: 'Great job!', body: 'Ledger added.' },
          },
          hints: ['Search for "Ledger"', 'Connect Load Balancer to it'],
        }),
      ],
    }),
    level({
