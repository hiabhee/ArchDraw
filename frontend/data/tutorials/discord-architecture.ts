      ...
      steps: [
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Media Pipeline', and add the Media Pipeline." },
          ...
          hints: ['Search for "Media Pipeline"', 'Connect Add Message Service to it'],
        }),
        step({
