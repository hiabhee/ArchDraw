      ...
      steps: [
        step({
          ...
          phases: {
            ...
            celebration: { heading: 'Supervisor added.', body: 'Now add observability.' },
          },
        ...
        step({
          ...
          phases: {
            ...
            intro: { heading: 'About Observability', body: 'Observability stacks collect traces, metrics, and logs from every agent step.' },
            teaching: { heading: 'Deep dive: Observability', body: 'Each tool call emits a span with inputs, outputs, and token counts. Dashboards alert when cost per session exceeds budget or when identical tool calls repeat — classic infinite-loop signatures.' },
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Observability', and add it." },
            connecting: { heading: 'Connect it', body: 'Connect Agent Orchestrator \u2192 Observability.' },
            celebration: { heading: 'AI Agent architecture complete!', body: 'You built a production-ready multi-agent system with supervision and observability.' },
          },
          hints: ['Search for "Observability"', 'Connect Agent Orchestrator to it'],
        }),
      ],
    }),
  ],
