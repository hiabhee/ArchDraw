      ...
      steps: [
        step({
          ...
          phases: {
            ...
            intro: { heading: 'About the Mobile Client', body: 'The Zoom client runs on desktop (Electron), mobile (native), and web (browser). Each platform must handle camera/microphone capture, video encoding, and network adaptation.' },
            teaching: { heading: 'Deep dive: Mobile Client', body: 'Zoom clients capture audio and video from local devices, encode them in real-time, and adapt quality based on available bandwidth. The client implements simulcast — encoding three quality layers (low, medium, high) simultaneously so the server can choose the best quality each receiver can handle. Without a well-built client, even the best server infrastructure cannot deliver smooth video.' },
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Mobile Client', and add the Mobile Client to the canvas." },
            connecting: { heading: 'Connect it up', body: 'First step — no connections needed yet.' },
            celebration: { heading: 'Great job!', body: 'Mobile Client added. This is where all video capture begins.' },
          },
        ...
        step({
          ...
          phases: {
            ...
            connecting: { heading: 'Connect it up', body: 'Connect Mobile Client \u2192 WebRTC Gateway. This is how video packets flow from the user to the server.' },
            celebration: { heading: 'Great job!', body: 'WebRTC Gateway added and connected.' },
          },
          hints: ['Search for "WebRTC"', 'Connect Mobile Client to it'],
        }),
      ],
    }),
    level({
      ...
      steps: [
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Meeting Service', and add the Meeting Service." },
          ...
          hints: ['Search for "Meeting Service"', 'Connect WebRTC Gateway to it'],
        }),
      ],
    }),
    level({
      ...
      steps: [
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Recording Service', and add the Recording Service." },
