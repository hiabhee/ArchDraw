      ...
      steps: [
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Rider App', and add the Rider App." },
        ...
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Matching Service', and add the Matching Service." },
          ...
          hints: ['Search for "Matching Service"', 'Connect API Gateway to it'],
        }),
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Location Service', and add the Location Service." },
          ...
          hints: ['Search for "Location Service"', 'Connect Matching Service to it'],
        }),
        step({
          component: 'Maps API',
          nodeType: 'maps_api',
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Maps API', and add the Maps API." },
      ...
      steps: [
        step({
          ...
          phases: {
            ...
            action: { heading: 'Your turn!', body: "Press \u2318K, search for 'Surge Pricing', and add Surge Pricing." },
          ...
          hints: ['Search for "Surge Pricing"', 'Connect Matching Service to it'],
        }),
      ],
    }),
  ],
